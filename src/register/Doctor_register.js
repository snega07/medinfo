...
import validation from '../Validator/doctor_validator';
const Doctor_Register=(props)=>{
...
useEffect(()=>{
 ...
 const sendData ={
    ...
    axios.post('http://localhost/unisys/doctor_register.php',sendData).then((result)=>{
        console.log(result);
    ...
    return(
        <div>
            ...
            <div className="row">
                <div className="col-md-6">Doctor Name</div>
            ...
            <div className="row">
                <div className="col-md-6">Qualification</div>
                <div className="col-md-6">
                    <input type="text" name="qualification" className='form-control'
                    onChange={handleChange} value={data.qualification}/>
